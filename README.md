...
> 
I decided to develop C++ code for an indoor training application that is running on an <b>Arduino nRF52840 Express</b> board and that comes as close as possible to the functionality of the <b>Xert app</b> (for Garmin Connect). [It became an integral part of a larger project: AIRFLOW](https://github.com/Berg0162/airflow)<br>
The following is an explanation of the science and math behind its fundamentals. <br>
